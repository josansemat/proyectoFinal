...
const SvgSprite = () => (
  <svg style={{ display: 'none' }}>
    <defs>
      {/* ... TUS ICONOS EXISTENTES (pitch, goal, trophy, user, logout) ... */}
      ...
      <symbol id="icon-user" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="5" /><path d="M20 21a8 8 0 0 0-16 0" /></symbol>
      <symbol id="icon-logout" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" /></symbol>

      {/* NUEVO ICONO MEJORADO: SETTINGS (Estilo línea moderno) */}
